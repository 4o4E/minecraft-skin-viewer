...
dependencies {
    implementation("top.e404.mcsk:http-client:2.5.1")
}
```
...
```kotlin
implementation("top.e404.mcsk:core:2.5.1")
implementation("top.e404.mcsk:http-client:2.5.1")
implementation("top.e404.mcsk:renderer-tavolo:2.5.1")
implementation("top.e404.mcsk:renderer-opengl:2.5.1")
```
...
- Tavolo CPU 渲染：`ghcr.io/4o4e/mc-skin-render-tavolo-linux:2.5.1`，[compose 部署参考](http-server-tavolo-linux/docker-compose.yml)
- OpenGL + Xvfb 渲染：`ghcr.io/4o4e/mc-skin-render-opengl-linux:2.5.1`，[compose 部署参考](http-server-opengl-linux/docker-compose.yml)
